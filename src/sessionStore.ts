...
function normalizeTurn(turn: Partial<ClaudeTurn>): ClaudeTurn {
  return {
    ...
    modelName: typeof turn.modelName === "string" ? turn.modelName : "",
    modelAlias: typeof turn.modelAlias === "string" ? turn.modelAlias : "",
    modelId: typeof turn.modelId === "string" ? turn.modelId : "",
